...
std::shared_ptr<Plan> Planner::do_planner(std::shared_ptr<Query> query, Context* context) {
    ...
    case ast::AstNodeKind::DropTable: {
    ...
    case ast::AstNodeKind::CreateIndex: {
    ...
    case ast::AstNodeKind::DropIndex: {
