...
create table customer (c_id integer, c_d_id integer, c_w_id integer, c_first text, c_middle text, c_last text, c_street_1 text, c_street_2 text, c_city text, c_state text, c_zip text, c_phone text, c_since text, c_credit text, c_credit_lim integer, c_discount real, c_balance real, c_ytd_payment real, c_payment_cnt integer, c_delivery_cnt integer, c_data text);
