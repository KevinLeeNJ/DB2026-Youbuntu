create table warehouse (w_id int, w_name char(20), w_street_1 char(40), w_street_2 char(40), w_city char(20), w_state char(2), w_zip char(9), w_tax float, w_ytd float);
create table district (d_id int, d_w_id int, d_name char(20), d_street_1 char(40), d_street_2 char(40), d_city char(20), d_state char(2), d_zip char(9), d_tax float, d_ytd float, d_next_o_id int);
create table customer (c_id int, c_d_id int, c_w_id int, c_first char(20), c_middle char(2), c_last char(40), c_street_1 char(40), c_street_2 char(40), c_city char(20), c_state char(2), c_zip char(9), c_phone char(16), c_since datetime, c_credit char(2), c_credit_lim float, c_discount float, c_balance float, c_ytd_payment float, c_payment_cnt int, c_delivery_cnt int, c_data char(100));
...
create table item (i_id int, i_im_id int, i_name char(40), i_price float, i_data char(50));
