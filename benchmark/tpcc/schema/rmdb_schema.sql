...
create table customer (c_id int, c_d_id int, c_w_id int, c_first char(20), c_middle char(2), c_last char(40), c_street_1 char(40), c_street_2 char(40), c_city char(20), c_state char(2), c_zip char(9), c_phone char(16), c_since char(19), c_credit char(2), c_credit_lim float, c_discount float, c_balance float, c_ytd_payment float, c_payment_cnt int, c_delivery_cnt int, c_data char(100));
